...
def _seed_master_data() -> None:
    ...
    customer = Party(id="CUST-1", party_type="customer", name="Cliente Demo", is_active=True)
    supplier = Party(id="SUP-1", party_type="supplier", name="Proveedor Demo", is_active=True)
