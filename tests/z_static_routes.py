...
static_rutes = [
    ...
    Route(
        ...
        text=[
            ...
            "<strong>B00001</strong>&nbsp;Centro Costos Nivel 1".encode("utf-8"),
            "<strong>B00011</strong>&nbsp;Centro Costos Nivel 2".encode("utf-8"),
            "<strong>B00111</strong>&nbsp;Centro Costos Nivel 3".encode("utf-8"),
            "<strong>B01111</strong>&nbsp;Centro Costos Nivel 4".encode("utf-8"),
            "<strong>B11111</strong>&nbsp;Centro Costos Nivel 5".encode("utf-8"),
        ],
    ),
    Route(
    ...
    Route(
        ...
        text=[
            ...
            "Unidades de Negocio".encode("utf-8"),
