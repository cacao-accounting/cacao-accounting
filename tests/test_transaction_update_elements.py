...
def test_update_elements_sources_are_configured_for_derived_documents():
    ...
    assert '{"value": "sales_request", "label": str(_LABEL_PEDIDO_VENTA)}' in sales
    assert '{"value": "sales_order", "label": str(_LABEL_ORDEN_VENTA)}' in sales
