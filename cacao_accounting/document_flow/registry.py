...
_ACTION_CREAR_PAGO = _l("Crear Pago")
_ACTION_CREAR_NOTA_CREDITO = _l("Crear Nota de Crédito")
_ACTION_CREAR_NOTA_DEBITO = _l("Crear Nota de Débito")
_ACTION_CREAR_ORDEN_COMPRA = _l("Crear Orden de Compra")
_ACTION_CREAR_COMPARATIVO_OFERTAS = _l("Crear Comparativo de Ofertas")
...
class DocumentType:
    ...
    label: LazyText | None = None
    module: str = "general"
    module_label: LazyText = "General"
...
DOCUMENT_TYPES: dict[str, DocumentType] = {
    ...
    "purchase_request": DocumentType(
        ...
        create_actions=(
            DocumentAction(
                _l("Crear Solicitud de Cotización"),
                "purchase_quotation",
                "compras.compras_solicitud_cotizacion_nueva",
                "from_request",
            ),
            DocumentAction(
                _l("Crear Cotización de Proveedor"),
                "supplier_quotation",
    ...
    "purchase_quotation": DocumentType(
        ...
        party_field="supplier_id",
        label=_l("Solicitud de Cotización"),
        module="purchases",
        module_label=_l("Compras"),
        permission_module="purchases",
    ...
    "supplier_quotation": DocumentType(
        ...
        party_field="supplier_id",
        label=_l("Cotización de Proveedor"),
        module="purchases",
        module_label=_l("Compras"),
        permission_module="purchases",
    ...
    "import_landed_cost": DocumentType(
        key="import_landed_cost",
        header_model=ImportLandedCost,
    ...
    "purchase_credit_note": DocumentType(
        ...
        parent_field="purchase_invoice_id",
        party_field="supplier_id",
        label=_l("Nota de Crédito de Compra"),
        module="purchases",
        module_label=_l("Compras"),
        permission_module="purchases",
    ...
    "purchase_debit_note": DocumentType(
        ...
        parent_field="purchase_invoice_id",
        party_field="supplier_id",
        label=_l("Nota de Débito de Compra"),
        module="purchases",
        module_label=_l("Compras"),
        permission_module="purchases",
    ...
    "sales_order": DocumentType(
        ...
        create_actions=(
            DocumentAction(
                _l("Crear Remisión de Mercadería Vendida"),
                "delivery_note",
    ...
    "sales_request": DocumentType(
        ...
        filter_fields=("document_no", "company", "customer_id", "customer_name", "posting_date", "grand_total", "docstatus"),
        create_actions=(
            DocumentAction(_l("Crear Cotización"), "sales_quotation", "ventas.ventas_cotizacion_nueva", "from_request"),
            DocumentAction(_l("Crear Orden de Venta"), "sales_order", "ventas.ventas_orden_venta_nuevo", "from_request"),
        ),
    ),
    "sales_quotation": DocumentType(
        ...
        filter_fields=("document_no", "company", "customer_id", "customer_name", "posting_date", "grand_total", "docstatus"),
        create_actions=(
            DocumentAction(_l("Crear Orden de Venta"), "sales_order", "ventas.ventas_orden_venta_nuevo", "from_quotation"),
        ),
    ),
    "delivery_note": DocumentType(
        ...
        party_field="customer_id",
        label=_l("Remisión de Mercadería Vendida"),
        module="inventory",
        module_label=_l("Inventario"),
        permission_module="inventory",
        ...
        create_actions=(
            ...
            DocumentAction(
                _l("Crear Movimiento de Inventario"),
                "stock_entry",
    ...
    "sales_credit_note": DocumentType(
        ...
        parent_field="sales_invoice_id",
        party_field="customer_id",
        label=_l("Nota de Crédito de Venta"),
        module="sales",
        module_label=_l("Ventas"),
        permission_module="sales",
    ...
    "sales_debit_note": DocumentType(
        ...
        parent_field="sales_invoice_id",
        party_field="customer_id",
        label=_l("Nota de Débito de Venta"),
        module="sales",
        module_label=_l("Ventas"),
        permission_module="sales",
        ...
        create_actions=(DocumentAction(_l("Crear Cobro"), "payment_entry", _ENDPOINT_PAGO_NUEVO, "from_sales_debit_note"),),
    ),
    ...
    "journal_entry": DocumentType(
        ...
        label=_l("Comprobante Contable"),
        module="accounting",
        module_label=_l("Contabilidad"),
...
ALLOWED_FLOWS: dict[tuple[str, str], FlowSpec] = {
    ...
    ("purchase_invoice", "import_landed_cost"): FlowSpec("purchase_invoice", "import_landed_cost", "landed_cost"),
    ...
    ("delivery_note", "sales_return"): FlowSpec("delivery_note", "sales_return", "return"),
    ("delivery_note", "stock_entry"): FlowSpec("delivery_note", "stock_entry", "stock"),
    ("sales_invoice", "sales_return"): FlowSpec("sales_invoice", "sales_return", "return"),
