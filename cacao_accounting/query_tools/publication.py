...
TOOL_EXTERNAL_SCOPES: dict[str, str] = {
    ...
    "accounting.get_budget_variance": "accounting.read",
    ...
    "inventory.get_transfers": "inventory.read",
    ...
    "dimensions.list": "accounting.read",
    "dimension_values.search": "accounting.read",
    "cost_centers.list": "accounting.read",
    "uoms.list": "inventory.read",
