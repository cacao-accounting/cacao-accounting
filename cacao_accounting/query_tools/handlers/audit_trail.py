...
@query_tool(
    ...
    description=_l("Obtiene la auditoría de un documento específico."),
...
@query_tool(
    ...
    description=_l("Resume eventos de auditoría por usuario y acción, sin exponer payloads internos."),
    required_permission="audit.reports.read",
    parameters_schema={
        "type": "object",
        "properties": {
