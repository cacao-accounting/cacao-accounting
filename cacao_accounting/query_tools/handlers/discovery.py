...
@query_tool(
    "ledgers.list",
    _l("Lista libros contables autorizados de una compañía."),
...
@query_tool(
    "parties.search",
    _l("Busca clientes y proveedores activos de una compañía."),
    required_module="accounting",
...
@query_tool(
    "items.search",
    _l("Busca artículos activos por código o nombre."),
...
@query_tool(
    "warehouses.list",
    _l("Lista almacenes activos de una compañía."),
    required_module="inventory",
    required_permission=_PERM_INVENTORY_REPORTS_READ,
    parameters_schema=_SCHEMA,
)
...
@query_tool(
    ...
    _l("Busca cuentas bancarias activas de una compañía."),
...
@query_tool(
    "dimensions.list",
    _l("Lista tipos de dimensión analítica activos."),
    required_module="accounting",
    required_permission=_PERM_ACCOUNTING_REPORTS_READ,
    parameters_schema=_SCHEMA,
)
...
@query_tool(
    ...
    _l("Busca valores de una dimensión por compañía."),
    required_module="accounting",
    required_permission=_PERM_ACCOUNTING_REPORTS_READ,
    parameters_schema={
        **_SCHEMA,
...
@query_tool(
    "cost_centers.list",
    _l("Lista centros de costo activos de una compañía."),
    required_module="accounting",
    required_permission=_PERM_ACCOUNTING_REPORTS_READ,
    parameters_schema=_SCHEMA,
)
...
@query_tool(
    "uoms.list",
    _l("Lista unidades de medida activas."),
    required_module="inventory",
    required_permission=_PERM_INVENTORY_REPORTS_READ,
    parameters_schema=_SCHEMA,
)
